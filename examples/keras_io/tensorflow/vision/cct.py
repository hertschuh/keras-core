...
def create_cct_model(
    ...
    attention_weights = ops.nn.softmax(layers.Dense(1)(representation), axis=1)
    weighted_representation = ops.matmul(
        ops.transpose(attention_weights), representation
    )
    weighted_representation = ops.squeeze(weighted_representation, -2)
